...
const ResultPrompt = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-2 h-screen relative">
      ...
      />
      <h1 className="font-bold text-3xl text-accent max-sm:text-2xl max-sm:text-center max-sm:m-1">
        Felicidades, haz creado una nueva obra de arte!
      </h1>
      <p className="text-center text-secondary pb-4">"{prompt.text}"</p>
      <div className="bg-slate-500 w-[512px] h-[512px] max-sm:w-[70%] max-sm:h-auto">
        <img
          src={result.result.data.url}
          alt="Image generated by IA"
          className="w-[512px] h-[512px] max-sm:w-auto max-sm:h-auto"
        />
      </div>
